...
public class GlobalExceptionHandler {
  ...
  @ResponseBody
  public ErrorResponse handleRestaurantExistsException(final RestaurantExistException ex) {
  ...
  @ResponseBody
  public ErrorResponse handleRestaurantNotFoundException(final RestaurantNotFoundException ex) {
